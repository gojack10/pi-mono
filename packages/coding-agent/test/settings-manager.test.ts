...
describe("SettingsManager", () => {
	...
	describe("split settings", () => {
		...
		it("should write volatile model defaults to local settings when split is active", async () => {
			...
			const manager = SettingsManager.create(projectDir, agentDir);
			manager.setDefaultModelAndProvider("example-provider", "example-model");
			...
			expect(localSettings.defaultProvider).toBe("example-provider");
			expect(localSettings.defaultModel).toBe("example-model");
